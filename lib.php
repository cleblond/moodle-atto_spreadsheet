 ...
 */
function atto_spreadsheet_strings_for_js() {
    global $PAGE;
 ...
 */
function atto_spreadsheet_params_for_js($elementid, $options, $fpoptions) {
	global $USER, $COURSE;
	//coursecontext
	...
	$params['usercontextid'] = $usercontextid;
		...
		if(!has_capability('atto/spreadsheet:visible', $coursecontext) ){
			$disabled=true;
		 }
